    ...
    <div className="space-y-8 pb-12">
      ...
      {isCreateModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="w-full max-w-lg rounded-2xl border border-[#1f1f2e] bg-[#0d0d15] p-6 shadow-2xl">
            <h3 className="text-xl font-bold text-white mb-4">{t("createSubscription")}</h3>
            <form onSubmit={handleCreateSubscription} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-gray-400 uppercase tracking-wider">{t("tenantNameCol")}</label>
                  <input
                    type="text"
                    required
                    value={newTenantName}
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-gray-400 uppercase tracking-wider">{t("tenantEmailCol")}</label>
                  <input
                    type="email"
                    required
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-gray-400 uppercase tracking-wider">{t("tenantPlanCol")}</label>
                  <select
                    value={newTenantPlan}
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-gray-400 uppercase tracking-wider">Message Limit</label>
                  <input
                    type="number"
                    required
      ...
      {isEditModalOpen && currentTenant && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="w-full max-w-4xl rounded-2xl border border-[#1f1f2e] bg-[#0d0d15] shadow-2xl overflow-hidden flex flex-col md:flex-row">
            {/* Left: Form */}
            <div className="flex-1 p-6 border-b md:border-b-0 md:border-r border-[#1f1f2e]">
              ...
              <form onSubmit={handleSaveEdit} className="space-y-5">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-gray-400 uppercase tracking-wider">Limit</label>
                    <input
                      type="number"
                      required
            ...
            {/* Right: Snippets */}
            <div className="w-full md:w-80 bg-[#07070b] p-6 space-y-6">
              <div>
                <h4 className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-4">Integration Code</h4>
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="bg-[#0d0d15] border border-[#1f1f2e] rounded-lg p-2 font-mono text-[10px] text-gray-400 break-all leading-relaxed">
