...
const translationsEn = {
  ...
  upgradeTitle: "Billing & Upgrade",
  upgradeSubtitle: "Manage your current subscription, usage limits, and upgrade path.",
  ...
  planProDesc: "For growing teams running AI support across live channels.",
  pricingGetPro: "Get Pro",
  planUltraDesc: "For high-volume teams that need priority operations and support.",
  pricingGetUltra: "Get Ultra",
  featBilingualRag: "Bilingual RAG knowledge base",
  featOmnichannel: "Web, WhatsApp, and Telegram channels",
  featChromaVector: "Chroma vector search",
  featHumanHandoff: "Human handoff queue",
  featAnalyticsDash: "Analytics dashboard",
  featAllProBenefits: "Everything in Pro",
  featSlaGuarantee: "SLA guarantee",
  featPriorityHandoff: "Priority human handoff",
  pricingPageTitle: "Choose the right support plan.",
  pricingPageSubtitle: "Start small, then scale your AI support volume as your business grows.",
  pricingFooterNote: "All plans include bilingual support, hosted dashboards, and guided setup.",
...
const translationsAr: Partial<Translations> = {
  ...
  upgradeTitle: "الفوترة وترقية الباقة",
  upgradeSubtitle: "أدر اشتراكك الحالي وحدود الاستخدام ومسار الترقية.",
  compareAllPlans: "قارن كل الباقات",
  ...
  planFreeName: "المجانية",
  planFreePrice: "$0 / شهرياً",
  ...
  planProDesc: "للفرق المتنامية التي تدير دعماً ذكياً عبر القنوات المباشرة.",
  pricingGetPro: "اختيار Pro",
  planUltraDesc: "للفرق عالية الاستخدام التي تحتاج أولوية تشغيل ودعم.",
  pricingGetUltra: "اختيار Ultra",
  featBilingualRag: "قاعدة معرفة RAG ثنائية اللغة",
  featOmnichannel: "قنوات الموقع وواتساب وتليجرام",
  featChromaVector: "بحث متجهي عبر Chroma",
  featHumanHandoff: "طابور تحويل للدعم البشري",
  featAnalyticsDash: "لوحة تحليلات",
  featAllProBenefits: "كل مزايا Pro",
  featSlaGuarantee: "ضمان مستوى الخدمة",
  featPriorityHandoff: "تحويل بشري ذو أولوية",
  pricingPageTitle: "اختر باقة الدعم المناسبة.",
  pricingPageSubtitle: "ابدأ بحجم صغير ثم وسّع دعم الذكاء الاصطناعي مع نمو عملك.",
  pricingFooterNote: "تشمل كل الباقات دعماً ثنائي اللغة ولوحات تحكم مستضافة وإعداداً موجهاً.",
