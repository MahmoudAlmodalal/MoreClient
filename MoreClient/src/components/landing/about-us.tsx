...
export function AboutUs() {
  ...
  return (
    <section id="about" className="relative py-20 border-t border-border-custom bg-background">
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        ...
        <div className="grid gap-8 md:grid-cols-12 md:items-stretch">
          {/* About Text */}
          <div className="md:col-span-7 flex flex-col justify-center text-start space-y-5 text-sm sm:text-base leading-relaxed text-foreground/80">
            <p>
              {language === "ar" ? (
                <>
          ...
          <div className="md:col-span-5 flex items-center">
            <div className="w-full rounded-2xl border border-border-custom bg-card p-6 sm:p-8 text-start shadow-sm flex flex-col justify-center">
              <ShieldCheck className="w-12 h-12 text-brand-600 dark:text-brand-400 mb-5" />
