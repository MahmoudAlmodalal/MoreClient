...
const translationsEn = {
  ...
  upgradeSubtitle: "Review usage limits and choose the plan that fits your support volume.",
...
const translationsAr: Partial<Translations> = {
  ...
  upgradeSubtitle: "راجع حدود الاستخدام واختر الباقة المناسبة لحجم الدعم لديك.",
