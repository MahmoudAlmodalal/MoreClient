...
export function LandingFooter() {
  ...
  return (
    <footer className="border-t border-border bg-sidebar py-14 text-start">
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        <div className="grid gap-10 md:grid-cols-[1.5fr_1fr_1fr_1fr] pb-10 border-b border-border">
          {/* Logo / Description */}
          <div className="space-y-4">
            <FooterLogo />
            <p className="max-w-xs text-xs sm:text-sm leading-relaxed text-muted-fg">
              {language === "ar"
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5">
              {[
                ...
                <li key={l.label}>
                  <a href={l.href} className="text-xs sm:text-sm text-muted-fg hover:text-primary transition-colors">
                    {l.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3.5">
              <li className="flex items-center gap-2.5 text-xs sm:text-sm text-muted-fg">
                <Mail size={14} className="text-primary shrink-0" />
                <a href="mailto:support@moreresponse.com" className="hover:text-primary transition-colors">
                  support@moreresponse.com
                </a>
              </li>
              <li className="flex items-center gap-2.5 text-xs sm:text-sm text-muted-fg">
                <Phone size={14} className="text-primary shrink-0" />
                <a href="tel:+962790000000" className="hover:text-primary transition-colors">
                  +962 7 9000 0000
                </a>
              </li>
              <li className="flex items-center gap-2.5 text-xs sm:text-sm text-muted-fg">
        ...
        {/* Footer Bottom */}
        <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between text-xs text-muted-fg">
          <span>
            {language === "ar"
