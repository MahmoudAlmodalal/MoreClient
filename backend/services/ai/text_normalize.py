...
(alef/hamza/yaa/teh-marbuta) and strips diacritics + tatweel, which materially
improves lexical matching for AR queries that don't diacritize exactly like the
source documents.
"""
