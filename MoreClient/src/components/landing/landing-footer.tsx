    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 110 60" className="h-[46px] w-[84px] select-none">
      ...
      <g transform="translate(16, 22)">
        ...
        <g transform="translate(23, 5)">
          ...
          <path d="M 6 8 A 1.8 1.8 0 0 1 9 8" fill="none" stroke={theme === "dark" ? "#18181b" : "#ffffff"} strokeWidth="1.8" strokeLinecap="round" />
          <path d="M 11 8 A 1.8 1.8 0 0 1 14 8" fill="none" stroke={theme === "dark" ? "#18181b" : "#ffffff"} strokeWidth="1.8" strokeLinecap="round" />
          <path d="M 6 12 A 4 4 0 0 0 14 12" fill="none" stroke={theme === "dark" ? "#18181b" : "#ffffff"} strokeWidth="2.0" strokeLinecap="round" />
        </g>
